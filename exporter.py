...
from dependency_manager import dependency_manager, is_available, safe_import
...
class ResultExporter:
    ...
    def __init__(self):
        ...
        # Check dependency availability using centralized manager
        self.reportlab_available = is_available('reportlab')
        self.pandas_available = is_available('pandas')
        self.excel_available = is_available('openpyxl')
    ...
    def _setup_pdf_components(self):
        """Setup PDF components if ReportLab is available"""
        try:
            ...
            self.logger.error(f"Error setting up PDF components: {e}")
    ...
    def setup_pdf_styles(self):
        ...
        try:
            ...
            self.logger.error(f"Error setting up PDF styles: {e}")
            self.reportlab_available = False
    ...
    def _export_csv_pandas(self, filename: str, competitor_keywords: Dict[str, Dict],
        ...
        try:
            ...
            if pd is None:
                self.logger.warning("Pandas not available, falling back to standard CSV export")
                return self._export_csv_standard(filename, competitor_keywords, missing_keywords, metadata)
            ...
            self.logger.error(f"Error in pandas export: {e}")
            return self._export_csv_standard(filename, competitor_keywords, missing_keywords, metadata)
    ...
    def export_to_pdf(self, filename: str, competitor_keywords: Dict[str, Dict],
        ...
        try:
            ...
            self.logger.error(f"ReportLab import error: {e}")
            self.reportlab_available = False
            return False
        except Exception as e:
    ...
    def _add_title_page(self, story: List, metadata: Dict):
        ...
        try:
            ...
            self.logger.error(f"Error in PDF title page: {e}")
    ...
    def _add_executive_summary(self, story: List, competitor_keywords: Dict[str, Dict],
        ...
        try:
            ...
            self.logger.error(f"Error in PDF executive summary: {e}")
    ...
    def _add_competitor_analysis(self, story: List, competitor_keywords: Dict[str, Dict]):
        ...
        try:
            ...
            self.logger.error(f"Error in PDF competitor analysis: {e}")
    ...
    def _add_missing_keywords_analysis(self, story: List, missing_keywords: List[Dict]):
        ...
        try:
            ...
            self.logger.error(f"Error in PDF missing keywords analysis: {e}")
    ...
    def _add_recommendations(self, story: List, missing_keywords: List[Dict]):
        ...
        try:
            ...
            self.logger.error(f"Error in PDF recommendations: {e}")
